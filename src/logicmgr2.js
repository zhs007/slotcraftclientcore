const { SCLogicState2, SCLogicStep2, SCLogicGameResult2, LogicGameResult2 } = require('./logicstate2.js');
...
class SCLogicMgr2 {
    constructor() {
        ...
        this.callbackUIFrameworks = null; // callback(curNum, totalNum)
    ...
    addListener(listener) { this.lstGameResult2Listener.push(listener); }

    addUIFrameworksListener(callbackUIFrameworks) { this.callbackUIFrameworks = callbackUIFrameworks; }
    ...
    _onUIFrameworks(curNum, totalNum) {
        if (this.callbackUIFrameworks) {
            this.callbackUIFrameworks(curNum, totalNum);
        }
    }
