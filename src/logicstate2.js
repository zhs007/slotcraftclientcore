...
class GameStep {
    ...
    async _gameStepRunLogic(gr2, mgr2, runingindex) {
        ...
        if (this.toUiStateData) {
            let allNumber=this.toUiStateData.respin.curRespinNum +
            this.toUiStateData.respin.lastRespinNum
            - this.toUiStateData.respin.curAddRespinNum;
            if(this.toUiStateData.curStateData.nexttrigger){
                allNumber=this.toUiStateData.respin.curRespinNum +
                this.toUiStateData.respin.lastRespinNum;
            }
            mgr2._onUIFGNum(
                this.toUiStateData.respin.curRespinNum,allNumber);
        }
